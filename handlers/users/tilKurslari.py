...
async def lang_eng(message: types.Message):
    await message.answer('Enjoy!', reply_markup=lessons)
...
async def lang_ru(message: types.Message):
    await message.answer('Наслаждаться!', reply_markup=lessons)
...
async def lang_fr(message: types.Message):
    await message.answer('Profitez!', reply_markup=lessons)
...
async def lang_kr(message: types.Message):
    await message.answer('즐기다!', reply_markup=lessons)
